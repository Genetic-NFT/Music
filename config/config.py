...
API_ID = int(getenv("22026335"))
API_HASH = getenv("407869022dad460d7400ecc1dae03117")

## Get it from @Botfather in Telegram.
BOT_TOKEN = getenv("6005794108:AAFESLyZM_VdXoxslS6twRYu6C7fDiXiQno")
...
LOG_GROUP_ID = int(getenv("-1001964851099"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("NiaaaaaBOT")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("5092447481").split())
